    ...
    return of(
      {
        ...
        stratumURL: "stratum.kano.is",
        stratumPort: 3333,
        stratumUser: "1BURGERAXHH6Yi6LRybRJK7ybEm5m5HwTr.GekkoGamma",
        ...
        fallbackStratumUser: "1BURGERAXHH6Yi6LRybRJK7ybEm5m5HwTr.GekkoGamma",
        ...
        poolDifficulty: 131072,
        lastSubmittedDiff: 4096000,
        workReceived: 512,
        boardTemp: 42,
        responseTime: 12,
        ...
        frequency: 600,
        version: "v2.13.1-gekko.2-dev.5",
        axeOSVersion: "v2.13.1-gekko.2-dev.5",
        idfVersion: "v5.5.1",
        resetReason: "Power-on reset",
        boardVersion: "gekko-601-12",
        ...
        blockHeight: 897311,
        scriptsig: "..%..h..,H...stratum.kano.is/",
        networkDifficulty: 121000000000000,
        hashrateMonitor: {
          asics: [{
            total: 543.1,
            domains: [137.2, 134.8, 136.1, 135.0],
            errorCount: 1,
          }],
          hashrate: 543.1,
        },
        blockFound: 0,
        showNewBlock: false,
        coinbaseOutputs: [{value: 313600000, address: "1BURGERAXHH6Yi6LRybRJK7ybEm5m5HwTr"}],
        coinbaseValueTotalSatoshis: 313600000,
        coinbaseValueUserSatoshis: 313600000,
      }
    ).pipe(delay(1000));
  }
