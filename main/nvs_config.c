...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_PID_P]                = {.nvs_key_name = "pid_p",          .type = TYPE_FLOAT, .default_value = {.f = 3.0f},   .danger_zone_gated = true},
    [NVS_CONFIG_PID_I]                = {.nvs_key_name = "pid_i",          .type = TYPE_FLOAT, .default_value = {.f = 0.1f},   .danger_zone_gated = true},
    [NVS_CONFIG_PID_D]                = {.nvs_key_name = "pid_d",          .type = TYPE_FLOAT, .default_value = {.f = 1.0f},   .danger_zone_gated = true},
