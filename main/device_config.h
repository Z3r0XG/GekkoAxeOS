...
static const AsicConfig ASIC_BM1370_GEKKO = { .id = BM1370, .name = "BM1370", .chip_id = 1370, .default_frequency_mhz = 600, .frequency_options = BM1370_FREQUENCY_OPTIONS, .default_voltage_mv = 1100, .voltage_options = BM1370_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 128, .small_core_count = 2040, .hash_domains = 4, .hashrate_test_percentage_target = 0.85, };
...
static const FamilyConfig FAMILY_GEKKO_GT       = { .id = GEKKO_GT,       .name = "GekkoAxe-GT",    .asic = ASIC_BM1370_GEKKO, .asic_count = 2, .max_power =  60, .power_offset = 10, .nominal_voltage = 12, .voltage_domains = 1, .swarm_color = "cyan",  };
static const FamilyConfig FAMILY_GEKKO_GAMMA    = { .id = GEKKO_GAMMA,    .name = "GekkoAxe-γ",     .asic = ASIC_BM1370_GEKKO, .asic_count = 1, .max_power =  40, .power_offset = 5,  .nominal_voltage = 5,  .voltage_domains = 1, .swarm_color = "green", };
static const FamilyConfig FAMILY_GEKKO_GAMMA_12V= { .id = GEKKO_GAMMA_12V,.name = "GekkoAxe-γ",  .asic = ASIC_BM1370_GEKKO, .asic_count = 1, .max_power =  50, .power_offset = 5,  .nominal_voltage = 12, .voltage_domains = 1, .swarm_color = "green", };
